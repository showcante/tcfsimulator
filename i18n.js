const I18N = {
  en: {
    ...
    opt_task2_standard: 'Reliable (Turn-by-Turn)',
    opt_task2_vertex: 'Advanced Vertex Live (Experimental)',
    btn_start: 'Start',
    btn_pause: 'Pause',
    btn_reset: 'Reset',
  ...
  fr: {
    ...
    label_task2_mode: 'Moteur de la tâche 2',
    label_task2_ws_url: 'URL WS Vertex de la tâche 2',
    ...
    opt_task2_standard: 'Fiable (tour par tour)',
    opt_task2_vertex: 'Vertex Live avancé (expérimental)',
    btn_start: 'Démarrer',
    btn_pause: 'Pause',
    ...
    btn_task2_connect: 'Connecter la tâche 2 en direct',
    btn_task2_disconnect: 'Déconnecter la tâche 2 en direct',
    btn_task2_send_live: "Envoyer la dernière transcription à l'examinateur",
    ...
    mic_input_level: 'Niveau du micro',
    month_february: 'Février',
    month_january: 'Janvier',
    bank_all: 'Toutes',
    status_disconnected: 'Déconnecté',
    speaking_hint_vertex: 'Pour le mode avancé de la tâche 2, connectez d’abord votre endpoint WebSocket Cloud Run.',
