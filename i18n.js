const I18N = {
  en: {
    ...
    listen_res3_title: 'RFI Français Facile - Diplômes & Tests',
    listen_res3_desc:
    ...
    bank_all: 'All',
    footer_copy: '© 2026 DRC Systems. All rights reserved.',
  ...
  fr: {
    ...
    listen_res1_title: 'Tests de compréhension orale FreeTCF',
    listen_res1_desc:
      'Séries d’écoute de type pratique avec format QCM proche du TCF pour un entraînement chronométré.',
    listen_res2_title: 'TV5MONDE - Préparation au TCF',
    listen_res2_desc:
      'Activités d’apprentissage structurées pour la préparation au TCF, incluant des exercices de compréhension orale à différents niveaux.',
    listen_res3_title: 'RFI Français Facile - Diplômes et tests',
    listen_res3_desc:
      'Contenus de compréhension orale et d’entraînement linguistique utiles pour les réflexes d’écoute et le vocabulaire.',
    ...
    read_res1_title: 'TV5MONDE - Préparation au TCF',
    read_res1_desc:
      'Utilisez cette page pour la préparation au TCF et accédez aux activités de compréhension écrite pour travailler les textes courts et longs.',
    read_res2_title: 'Tests de compréhension écrite FreeTCF',
    read_res2_desc:
      'Tests de lecture orientés pratique avec format proche du TCF pour améliorer la gestion du temps et la précision.',
    ...
    writing_panel_title: 'Expression écrite',
    writing_panel_lead: 'Trois tâches avec minuterie commune et compteurs de mots.',
    writing_total_time: 'Temps total',
    writing_task1_hint: 'Rédigez un message pratique court (courriel/note).',
    writing_task2_hint: 'Rédigez un texte d’argumentation/opinion avec une structure claire.',
    writing_task3_hint: 'Rédigez une réponse de comparaison/analyse avec des exemples.',
    writing_task1_placeholder: 'Rédigez votre réponse de la tâche 1...',
    writing_task2_placeholder: 'Rédigez votre réponse de la tâche 2...',
    writing_task3_placeholder: 'Rédigez votre réponse de la tâche 3...',
    writing_copy_hint:
      'Après avoir terminé cette tâche, cliquez sur le bouton puis collez le texte dans votre IA favorite pour évaluer votre performance !',
    ...
    speaking_panel_lead: 'Prompts oraux des tâches 2 et 3, relecture et transcription en direct.',
    speaking_warning_note:
      'Les enregistrements sont limités à 1 minute seulement. Nos développeurs travaillent à l’amélioration, restez à l’écoute !',
    speaking_audio_settings: 'Paramètres audio des consignes',
    speaking_hint_api: 'Utilisez le mode Gemini avec le serveur local et la variable GEMINI_API_KEY.',
    speaking_hint_replay: 'La consigne est lue à voix haute. Utilisez la relecture au besoin.',
    speaking_task2_duration: 'Cette tâche dure 3 min 30.',
    speaking_task3_duration: 'Cette tâche dure 4 min 30.',
    speaking_transcript_placeholder: 'Votre transcription orale apparaîtra ici...',
    ...
    opt_lang_frfr: 'Français (France)',
    opt_lang_frca: 'Français (Canada)',
    opt_stt_server: 'STT serveur (Google)',
    opt_stt_browser: 'STT navigateur (Web Speech)',
    btn_start: 'Démarrer',
    btn_pause: 'Pause',
    btn_reset: 'Réinitialiser',
    btn_prev_question: 'Question précédente',
    btn_random_question: 'Question aléatoire',
    btn_next_question: 'Question suivante',
    btn_reveal_question: 'Afficher le texte de la question',
    btn_play_prompt: '▶ Lire la consigne',
    ...
    btn_copy_task2_eval: 'Copier la tâche 2 pour évaluation',
    btn_copy_task1: 'Copier la tâche 1',
    btn_copy_task2: 'Copier la tâche 2',
    btn_copy_task3: 'Copier la tâche 3',
    task_label_1: 'Tâche 1',
    task_label_2: 'Tâche 2',
    task_label_3: 'Tâche 3',
    status_idle: 'Inactif',
    month_february: 'Février',
    month_january: 'Janvier',
    bank_all: 'Toutes',
    footer_copy: '© 2026 DRC Systems. Tous droits réservés.',
